...
DataVisRaw = dlmread('./TrafficModel/Headquarters 11_001.fzp', ';', 22, 0);
...
for i = 1:nVeh
    ...
    DataVisStruct.t_arr = DataVisCell{i}(indSel,1)-DataVisCell{i}(indSel(1),1);
end
...
%%
figure
plot(DataVisStruct.t_arr, DataVisStruct.spd_veh_data(3,:))
