...
absolute_folder_path = os.path.abspath(r'.\tests\ToyotaColoradoNet') # absolute folder path of the vissim .inpx and .layx files
file_name = 'Colorado_CastleRock_74' # file name of vissim network and layout without extension .inpx and .layx

# flag to specify if need manual edits on the DesSpdDistr2SpeedLimitMap.csv file
ENABLE_MANUAL_EDIT_DESIRED_SPEED_MAP = 1
...
Vissim = com.Dispatch("Vissim.Vissim-64.2200") 
