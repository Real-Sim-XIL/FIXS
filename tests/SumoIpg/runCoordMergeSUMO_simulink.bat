...
REM start cmd /c ..\..\TrafficLayer\x64\Debug\TrafficLayer.exe -f config_SUMO.yaml
start cmd /c ..\..\TrafficLayer\x64\Release\TrafficLayer.exe -f config_SUMO_simulink.yaml
