...
/* -- Declarations of extern functions. -- */
 ...
 EXTERN_C_DECL void RS_DS_CM11_noSimulinkRS_useManeuver_DSRTInitMdl(
    void);

 EXTERN_C_DECL void RS_DS_CM11_noSimulinkRS_useManeuver_DSRTStartMdl(
    void);

 EXTERN_C_DECL void RS_DS_CM11_noSimulinkRS_useManeuver_DSRTStopMdl(
    void);
...
RS_DS_CM11_noSimulinkRS_useManeuver_DSRTStartMdl();
...
RS_DS_CM11_noSimulinkRS_useManeuver_DSRTStopMdl();
