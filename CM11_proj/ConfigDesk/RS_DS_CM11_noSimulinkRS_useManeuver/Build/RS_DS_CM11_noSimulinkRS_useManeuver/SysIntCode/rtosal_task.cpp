...
DsTProfilerSource ProfilerSrc_RS_DS_CM11_noSimulinkRS_useManeuver_DSRTMdlOutputs0;
DsTProfilerSource ProfilerSrc_RS_DS_CM11_noSimulinkRS_useManeuver_DSRTMdlUpdate0;
...
/* -- Declarations of extern functions. -- */
 ...
 EXTERN_C_DECL void RS_DS_CM11_noSimulinkRS_useManeuver_DSRTMdlOutputs0(
    void);

 EXTERN_C_DECL void RS_DS_CM11_noSimulinkRS_useManeuver_DSRTMdlUpdate0(
    void);
    ...
    DsTErrorList ErrorList, DsCTask* pTask) 
{
    ...
    pAppl->errorMessage(RTOSAL_DEADLINE_VIOLATION, "%s%s%s", "RS_DS_CM11_noSimulinkRS_useManeuver", pTask->getDescription(), CallCounterStr);
    ...
    ) 
{
    ...
    ProfilerSrc_RS_DS_CM11_noSimulinkRS_useManeuver_DSRTMdlOutputs0 =  dsProfilerCreateSource("RS_DS_CM11_noSimulinkRS_useManeuver_DSRTMdlOutputs0");
    ProfilerSrc_RS_DS_CM11_noSimulinkRS_useManeuver_DSRTMdlUpdate0 =  dsProfilerCreateSource("RS_DS_CM11_noSimulinkRS_useManeuver_DSRTMdlUpdate0");
...
#   ifdef TASK_ENABLE_PROFILING
    dsProfilerWriteEvent(ProfilerSrc_RS_DS_CM11_noSimulinkRS_useManeuver_DSRTMdlOutputs0, UserTimespanStart , 0, 0);
#   endif
    RS_DS_CM11_noSimulinkRS_useManeuver_DSRTMdlOutputs0();
#   ifdef TASK_ENABLE_PROFILING
    dsProfilerWriteEvent(ProfilerSrc_RS_DS_CM11_noSimulinkRS_useManeuver_DSRTMdlOutputs0, UserTimespanEnd , 0, 0);
#   endif
#   ifdef TASK_ENABLE_PROFILING
...
#   ifdef TASK_ENABLE_PROFILING
    dsProfilerWriteEvent(ProfilerSrc_RS_DS_CM11_noSimulinkRS_useManeuver_DSRTMdlUpdate0, UserTimespanStart , 0, 0);
#   endif
    RS_DS_CM11_noSimulinkRS_useManeuver_DSRTMdlUpdate0();
#   ifdef TASK_ENABLE_PROFILING
    dsProfilerWriteEvent(ProfilerSrc_RS_DS_CM11_noSimulinkRS_useManeuver_DSRTMdlUpdate0, UserTimespanEnd , 0, 0);
#   endif
#   ifdef TASK_ENABLE_PROFILING
    ...
    DsCTask* pTask, int numberOfAcceptedOverruns) 
{
    ...
    if (pTask->getOverrunCounter() > (unsigned int)numberOfAcceptedOverruns)
    {
        ...
        char CallCounterStr[32];
        snprintf(CallCounterStr, 32, "%llu", pTask->getCallCounter());
        pAppl->errorMessage(RTOSAL_TASK_OVERRUN, "%s%s%s%d", "RS_DS_CM11_noSimulinkRS_useManeuver", pTask->getDescription(), CallCounterStr, numberOfAcceptedOverruns);
    }
