...
/* -- Declarations of extern functions. -- */
 ...
 EXTERN_C_DECL void RS_DS_CM11_SimulinkRS_DSRTInitMdl(
    void);

 EXTERN_C_DECL void RS_DS_CM11_SimulinkRS_DSRTStartMdl(
    void);

 EXTERN_C_DECL void RS_DS_CM11_SimulinkRS_DSRTStopMdl(
    void);
...
RS_DS_CM11_SimulinkRS_DSRTStartMdl();
...
RS_DS_CM11_SimulinkRS_DSRTStopMdl();
...
pApp->setIoResourceMap(ErrorList, &g_ResourceMap);
    rs_ds_cm11_simulinkrs_fcnModule_SIDS1_TID1 = DsCFcnModule::create(ErrorList, pApp);
ApSimEngineOnInitIoPreRtosInit_ctlcBODY_1_Ethernet_Setup_i1_(ErrorList, pApp);
ApSimEngineOnInitIoPreRtosInit_ctlcBODY_3_TCP_i1_(ErrorList, pApp);
...
ApSimEngineOnInitIoPostRtosInit_ctlcBODY_0_TCP_i1_(ErrorList);
...
MemoryUsage = &pDiagnosticsBlock->MemoryUsage;
...
ApSimEngineOnStartIo_ctlcBODY_0_TCP_i1_(ErrorList);
...
ApSimEngineOnStopIo_ctlcBODY_0_TCP_i1_(ErrorList);
...
ApSimEngineOnUnloadIo_ctlcBODY_0_TCP_i1_(ErrorList);
...
ApSimEngineRunTimeInit(
    DsTErrorList ErrorList, Int32 calledOnStart) 
{
ApSimEngineRunTimeInit_ctlcBODY_0_TCP_i1_(ErrorList);
if (calledOnStart)
{
}
