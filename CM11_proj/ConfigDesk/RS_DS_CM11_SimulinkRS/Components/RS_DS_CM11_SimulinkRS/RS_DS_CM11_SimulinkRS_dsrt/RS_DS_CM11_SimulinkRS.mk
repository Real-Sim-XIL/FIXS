...
BUILD_ERROR                    = [sprintf('DSRT MAKE ERROR: Make process failed for model RS_DS_CM11_SimulinkRS.')]
SYS_TARGET_FILE                = any
PROJ_MARKER_FILE               = no
...
DS_PROTECTION                     = OFF
MW_MAKEFILE                       = RS_DS_CM11_SimulinkRS.mk
...
# MW_COMPUTER                     = PCWIN64
MW_MODEL                          = RS_DS_CM11_SimulinkRS
MW_MODEL_MODULES                  = RS_DS_CM11_SimulinkRS_data.c RS_DS_CM11_SimulinkRS_dsrtmdlfcn.c RS_DS_CM11_SimulinkRS_dsrtmf.c RS_DS_CM11_SimulinkRS_dsrttf.c RS_DS_CM11_SimulinkRS_dsrtvdf.c rtGetInf.c rtGetNaN.c rt_nonfinite.c CM_Main.c CM_Vehicle.c User.c IO.c app_tmp.c
# MW_MODEL_MODULES_OBJ            = RS_DS_CM11_SimulinkRS_data.obj RS_DS_CM11_SimulinkRS_dsrtmdlfcn.obj RS_DS_CM11_SimulinkRS_dsrtmf.obj RS_DS_CM11_SimulinkRS_dsrttf.obj RS_DS_CM11_SimulinkRS_dsrtvdf.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj CM_Main.obj CM_Vehicle.obj User.obj IO.obj app_tmp.obj 
MW_S_FUNCTIONS                    = 
# MW_S_FUNCTIONS_OBJ              = 
MW_S_FUNCTIONS_LIB                = 
# MW_SOLVER                       = 
...
MASTER_ANCHOR_DIR                 = 
START_DIR                         = C:\CM_Projects\RealSimCm11Prj\ConfigDesk\RS_DS_CM11_SimulinkRS\Components\RS_DS_CM11_SimulinkRS
...
MW_MODELREFS                      = 
MW_MODELREF_LINK_RSPFILE          = RS_DS_CM11_SimulinkRS_ref.rsp
...
%set DSRT_COMMON_HDR_DIRPATHS += \
    "$(START_DIR)" \
    "$(START_DIR)\RS_DS_CM11_SimulinkRS_dsrt" \
...
%set LIB_BASENAME = RS_DS_CM11_SimulinkRS
...
INTERFACE_LIB_$(LIB_BASENAME)_CC_SRC_FILES := RS_DS_CM11_SimulinkRS.$(MW_TARGET_LANG_EXT) 
