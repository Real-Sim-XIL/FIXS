...
const vector <int> serverPort = { 2336 };

const vector <unsigned short> selfServerPortUserInput = { 423 }; // client connect to this port
const vector <string> egoIdVec = { "flow_1.7" };
