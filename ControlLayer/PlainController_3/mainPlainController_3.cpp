...
const vector <int> serverPort = { 2335 };

const vector <unsigned short> selfServerPortUserInput = { 422 }; // client connect to this port
const vector <string> egoIdVec = { "flow_1.8" };
