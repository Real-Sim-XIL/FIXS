...
const vector <int> serverPort = { 2337 };

const vector <unsigned short> selfServerPortUserInput = { 424 }; // client connect to this port
const vector <string> egoIdVec = { "flow_1.10" };
