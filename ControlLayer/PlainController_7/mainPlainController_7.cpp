...
const vector <int> serverPort = { 2339 };

const vector <unsigned short> selfServerPortUserInput = { 426 }; // client connect to this port
const vector <string> egoIdVec = { "flow_0.9" };
