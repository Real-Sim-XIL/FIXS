...
const vector <int> serverPort = { 2350 };

const vector <unsigned short> selfServerPortUserInput = { 437 }; // client connect to this port
const vector <string> egoIdVec = { "flow_0.15" };
