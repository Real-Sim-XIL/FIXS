...
const vector <int> serverPort = { 2351 };

const vector <unsigned short> selfServerPortUserInput = { 438 }; // client connect to this port
const vector <string> egoIdVec = { "flow_0.16" };
