...
const vector <int> serverPort = { 2346 };

const vector <unsigned short> selfServerPortUserInput = { 433 }; // client connect to this port
const vector <string> egoIdVec = { "flow_1.15" };
