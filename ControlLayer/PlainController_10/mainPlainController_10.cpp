...
const vector <int> serverPort = { 2342 };

const vector <unsigned short> selfServerPortUserInput = { 429 }; // client connect to this port
const vector <string> egoIdVec = { "flow_0.12" };
