...
const vector <int> serverPort = { 2343 };

const vector <unsigned short> selfServerPortUserInput = { 430 }; // client connect to this port
const vector <string> egoIdVec = { "flow_1.12" };
