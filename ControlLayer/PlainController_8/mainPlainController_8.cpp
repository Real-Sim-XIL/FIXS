...
const vector <int> serverPort = { 2340 };

const vector <unsigned short> selfServerPortUserInput = { 427 }; // client connect to this port
const vector <string> egoIdVec = { "flow_0.8" };
