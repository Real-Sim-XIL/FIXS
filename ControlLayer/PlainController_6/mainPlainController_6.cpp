...
const vector <int> serverPort = { 2338 };

const vector <unsigned short> selfServerPortUserInput = { 425 }; // client connect to this port
const vector <string> egoIdVec = { "flow_1.11" };
