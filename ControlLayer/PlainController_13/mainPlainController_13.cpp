...
const vector <int> serverPort = { 2345 };

const vector <unsigned short> selfServerPortUserInput = { 432 }; // client connect to this port
const vector <string> egoIdVec = { "flow_1.14" };
