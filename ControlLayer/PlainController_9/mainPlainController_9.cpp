...
const vector <int> serverPort = { 2341 };

const vector <unsigned short> selfServerPortUserInput = { 428 }; // client connect to this port
const vector <string> egoIdVec = { "flow_0.11" };
