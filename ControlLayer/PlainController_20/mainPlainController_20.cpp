...
const vector <int> serverPort = { 2352 };

const vector <unsigned short> selfServerPortUserInput = { 439 }; // client connect to this port
const vector <string> egoIdVec = { "flow_0.17" };
