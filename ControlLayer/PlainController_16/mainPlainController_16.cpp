...
const vector <int> serverPort = { 2348 };

const vector <unsigned short> selfServerPortUserInput = { 435 }; // client connect to this port
const vector <string> egoIdVec = { "flow_0.13" };
