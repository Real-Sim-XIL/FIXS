...
const vector <int> serverPort = { 2349 };

const vector <unsigned short> selfServerPortUserInput = { 436 }; // client connect to this port
const vector <string> egoIdVec = { "flow_0.14" };
