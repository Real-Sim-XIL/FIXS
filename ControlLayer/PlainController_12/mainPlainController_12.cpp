...
const vector <int> serverPort = { 2344 };

const vector <unsigned short> selfServerPortUserInput = { 431 }; // client connect to this port
const vector <string> egoIdVec = { "flow_1.13" };
