...
fileName = './coordMerge_v1_paper.csv';
...
%         id = str2double(curId(13:end))*ones(size(link));
        ...
        if strcmpi(link(1), '2')
            ...
            %             pos(isnan(link)) = nan;
            pos(strcmpi(link, ':0_0')) = pos(strcmpi(link, ':0_0'))+800.67;
            pos(strcmpi(link, '3')) = pos(strcmpi(link, '3'))+800.67+3;
            pos(strcmpi(link, ':1_0')) = pos(strcmpi(link, ':1_0'))+800.67+3+148.09;
            pos(strcmpi(link, '4')) = pos(strcmpi(link, '4'))+800.67+3+148.09+7.7;
            pos(strcmpi(link, ':4-end_0')) = pos(strcmpi(link, ':4-end_0'))+800.67+3+148.09+7.7+112.97;
            pos(strcmpi(link, '5')) = pos(strcmpi(link, '5'))+800.67+3+148.09+7.7+112.97;
        elseif strcmpi(link(1), '1')
            mainOrRamp = 1;
            
%             pos(isnan(link)) = nan;
%             pos(strcmpi(link, '1')) = pos(strcmpi(link, '1'))+498.5;
            pos(strcmpi(link, ':0_1')) = pos(strcmpi(link, ':0_1'))+798.57;
            pos(strcmpi(link, '3')) = pos(strcmpi(link, '3'))+798.57+3;
            pos(strcmpi(link, ':1_0')) = pos(strcmpi(link, ':1_0'))+798.57+3+148.09;
            pos(strcmpi(link, '4')) = pos(strcmpi(link, '4'))+798.57+3+148.09+7.7;
            pos(strcmpi(link, ':4-end_0')) = pos(strcmpi(link, ':4-end_0'))+798.57+3+148.09+7.7+112.97;
            pos(strcmpi(link, '5')) = pos(strcmpi(link, '5'))+798.57+3+148.09+7.7+112.97;

%             pos(isnan(link)) = nan;
%             pos(strcmpi(link, '1')) = pos(strcmpi(link, '1'))+498.5;
%             pos(strcmpi(link, '3')) = pos(strcmpi(link, '3'))+498.5+795.57;
%             pos(strcmpi(link, '4')) = pos(strcmpi(link, '4'))+498.5+795.57+146.09;
%             pos(strcmpi(link, '5')) = pos(strcmpi(link, '5'))+498.5+795.57+146.09+112.97;
%             
%             pos = pos - 498.5;
        else
            keyboard
...
ind = find(contains(Data.idStr, 'flow_0.10')); 
figure; 
