...
REM start sumo-gui -c ./UAdemoRealSim_Final.sumocfg --step-length 0.1 --start --netstate-dump UAdemoRealSim_Orig_as0p1.xml --netstate-dump.precision 10 --end 70
...
:: start TrafficLayer
:: start cmd /c ..\..\TrafficLayer\x64\Release\TrafficLayer.exe -f test.yaml
